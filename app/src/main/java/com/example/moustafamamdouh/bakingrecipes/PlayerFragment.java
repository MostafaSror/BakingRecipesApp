...
public class PlayerFragment extends Fragment implements  ExoPlayer.EventListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String videoURL = this.getArguments().getString(DBContract.StepsEntries.COLUMN_VIDEOURL);
        String step_desc = this.getArguments().getString(DBContract.StepsEntries.COLUMN_DESCRIPTION);

        descriptionTextView.setText(step_desc);
    ...
    private void initializeMediaSession() {
        ...
        mMediaSession.setCallback(new PlayerFragment.MySessionCallback());
